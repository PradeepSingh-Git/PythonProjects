...
if dgnflex_available:
    try:
        ...
        ID_N_SA = 0x0E80 # Volvo Tester
        ID_N_TA_FUNCTIONAL = 0x1FFF # Volvo functional address
        ID_N_TA_PHYSICAL = 0x1602 # VCU1
        ...
        if DIAG_FRAMES_DEFINED_BY_NAME:
            ...
            FR_NAME_ID_TESTER_PHYS_REQ = 'VcmBackBoneDiagReqFrame2'
            FR_NAME_ID_TESTER_FUNC_REQ = 'VcmBackBoneDiagReqFrame1'
            FR_NAME_ID_ECU_RESP = ['VddmBackBoneDiagResFrame1', 'VddmBackBoneDiagResFrame2', 'VddmBackBoneDiagResFrame3']
        else:
